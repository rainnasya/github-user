...
class FollowingUserFragment: Fragment(R.layout.fragment_follow) {
    ...
    override fun onViewCreated(v: View, savedInstanceState: Bundle?) {
        ...
        showLoading(true)
        viewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(FollowingUserViewModel::class.java)
